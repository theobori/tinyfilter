 ...
 * @return int
 */
static __always_inline int filter_l2(struct hdr_cursor *nh, void *data_end,
                                     int *proto) {
  struct ethhdr *eth;
 ...
 * @return int
 */
static __always_inline int filter_ip_xdp_action(struct hdr_cursor *nh,
                                                void *data_end, int *proto) {
  struct iphdr *ip;
 ...
 * @return int
 */
static __always_inline int filter_ip6_xdp_action(struct hdr_cursor *nh,
                                                 void *data_end, int *proto) {
  struct ipv6hdr *ip6;
 ...
 * @return int
 */
static __always_inline int filter_l3(struct hdr_cursor *nh, void *data_end,
                                     int *proto) {
  switch (*proto) {
  case ETH_P_IP:
 ...
 * @return int
 */
static __always_inline int filter_udp_xdp_action(struct hdr_cursor *nh,
 ...
 * @return int
 */
static __always_inline int filter_icmp_xdp_action(struct hdr_cursor *nh,
                                                  void *data_end) {
  int t;
 ...
 * @return int
 */
static __always_inline int filter_l4(struct hdr_cursor *nh, void *data_end,
                                     int *proto) {
  switch (*proto) {
  case IPPROTO_TCP:
  case IPPROTO_UDP:
